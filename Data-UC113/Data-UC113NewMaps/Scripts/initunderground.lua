...
local sectorList = {
	...
	-- Calisto UBT
    { location = "D13-1", loadscreens = { "LS_Basement", "LS_Upstairs" }, },
	
	-- Sheraton UBT
    { location = "B2-1", loadscreens = { "LS_Basement", "LS_Upstairs" }, },

	-- Port Kip UBT
    { location = "D6-1", loadscreens = { "LS_Basement", "LS_Upstairs" }, },
	{ location = "D6-2", loadscreens = { "LS_Basement", "LS_Upstairs" }, },
	{ location = "D6-3", loadscreens = { "LS_Basement", "LS_Upstairs" }, },

	-- Galileo UBT
    { location = "G9-1", loadscreens = { "LS_Basement", "LS_Upstairs" }, },
	{ location = "G9-2", loadscreens = { "LS_Basement", "LS_Upstairs" }, },
	
	-- Troy UBT
    { location = "H13-1", loadscreens = { "LS_Basement", "LS_Upstairs" }, },
	{ location = "H13-2", loadscreens = { "LS_Basement", "LS_Upstairs" }, },
	
	-- Drake UBT
    { location = "H2-1", loadscreens = { "LS_Basement", "LS_Upstairs" }, },
	{ location = "I2-1", loadscreens = { "LS_Basement", "LS_Upstairs" }, },
	{ location = "I3-2", loadscreens = { "LS_Basement", "LS_Upstairs" }, },
...
local function PopulateSectors(difficultyLevel, gameStyle)
	...
	-- Atremo
	s["A10-1"].numTroops = ({ 1, 2, 3, 4 })[difficultyLevel]

	-- Calisto
	s["D13-1"].numTroops = ({ 1, 2, 3, 4 })[difficultyLevel]	

	-- Calisto Factory
	s["E13-1"].numTroops = ({ 10, 15, 20, 25 })[difficultyLevel]
	
	-- Sheraton
	s["B2-1"].numTroops = ({ 1, 2, 3, 4 })[difficultyLevel]	

	-- Galileo
	s["H8-1"].numTroops = ({ 1, 2, 3, 4 })[difficultyLevel]	
	s["H9-1"].numTroops = ({ 1, 2, 3, 4 })[difficultyLevel]	

	-- Port Kip
	s["D6-1"].numTroops = ({ 1, 2, 3, 4 })[difficultyLevel]	
	s["D6-2"].numTroops = ({ 1, 2, 3, 4 })[difficultyLevel]	

	-- Troy
	s["I14-1"].numTroops = ({ 1, 2, 3, 4 })[difficultyLevel]	
	s["J14-1"].numTroops = ({ 1, 2, 3, 4 })[difficultyLevel]	

	-- Drake
	s["I3-1"].numTroops = ({ 1, 2, 3, 4 })[difficultyLevel]	
	s["H3-1"].numTroops = ({ 1, 2, 3, 4 })[difficultyLevel]	
	s["I3-2"].numTroops = ({ 1, 2, 3, 4 })[difficultyLevel]
