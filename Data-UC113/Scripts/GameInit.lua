...
function InitNPCs()
	...
	if is_networked == 0 then
		...
		if i == 1 then
			-- G7
			AddNPCtoSector( Profil.Micky, 7, SectorY.MAP_ROW_G, 0 ) 
		elseif i == 2 then
			-- D9
			AddNPCtoSector( Profil.Micky, 9, SectorY.MAP_ROW_D, 0 ) 
		elseif i == 3 then	
			-- J13
			AddNPCtoSector( Profil.Micky, 13, SectorY.MAP_ROW_J, 0 )
		elseif i == 4 then
			-- F2
			AddNPCtoSector( Profil.Micky, 2, SectorY.MAP_ROW_F, 0 )
		elseif i == 5 then
			-- C6
	...
	-- Set up Carmen for UC-1.13
	AddNPCtoSector( Profil.CARMEN, 9, SectorY.MAP_ROW_A, 0 )
end
